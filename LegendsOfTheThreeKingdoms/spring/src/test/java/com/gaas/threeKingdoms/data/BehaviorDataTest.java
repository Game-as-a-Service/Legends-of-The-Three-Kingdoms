...
public class BehaviorDataTest {
    ...
    @Test
    public void testBountifulHarvestBehaviorToBehaviorDataConversion() {
        // Arrange
        Player playerA = createPlayer(
                "player-a",
                4,
        ...
        Kill currentPlayCard = new Kill(PlayCard.BS8008);
        BountifulHarvestBehavior behavior = new BountifulHarvestBehavior(
                game,
                playerA,
                reactionPlayers,
                playerB,
        ...
        behavior.putParam(BountifulHarvestBehavior.BOUNTIFUL_HARVEST_CARDS, Arrays.asList("BS7020", "BS8021", "BS9022"));
        ...
        assertTrue(behaviorData.isTargetPlayerNeedToResponse());
        assertFalse(behaviorData.isOneRound());
        List<String> drawCards = (List<String>) behaviorData.getParams().get(BountifulHarvestBehavior.BOUNTIFUL_HARVEST_CARDS);
        List<String> expectedCards = Arrays.asList("BS7020", "BS8021", "BS9022");
        assertEquals(expectedCards, drawCards);
    }

    @Test
    public void testBountifulHarvestBehaviorDataToBehaviorConversion() {
        // Arrange
        Player playerA = createPlayer(
                "player-a",
                4,
        ...
        BehaviorData behaviorData = BehaviorData.builder()
                .behaviorName(BountifulHarvestBehavior.class.getSimpleName())
                .behaviorPlayerId(playerA.getId())
                .currentReactionPlayerId(playerB.getId())
                .reactionPlayers(reactionPlayers)
                .cardId("BS8008")
                ...
                .params(new HashMap<>())
                .build();
        behaviorData.getParams().put(BountifulHarvestBehavior.BOUNTIFUL_HARVEST_CARDS, Arrays.asList("BS7020", "BS8021", "BS9022"));
        Game game = initGame("123456", List.of(playerA, playerB), playerB);
