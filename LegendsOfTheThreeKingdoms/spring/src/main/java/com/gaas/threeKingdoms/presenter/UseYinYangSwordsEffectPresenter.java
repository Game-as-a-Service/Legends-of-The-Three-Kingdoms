...
public class UseYinYangSwordsEffectPresenter implements UseYinYangSwordsEffectUseCase.UseYinYangSwordsEffectPresenter<List<UseYinYangSwordsEffectPresenter.GameViewModel>> {
