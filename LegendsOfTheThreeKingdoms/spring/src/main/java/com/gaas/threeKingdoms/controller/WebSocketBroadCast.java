...
public class WebSocketBroadCast {
    ...
    public void pushUseYinYangSwordsEffectEvent(UseYinYangSwordsEffectPresenter presenter) {
        ...
        try {
            for (UseYinYangSwordsEffectPresenter.GameViewModel viewModel : viewModels) {
            ...
            System.err.println("****************** pushUseYinYangSwordsEffectEvent ");
            e.printStackTrace();
        }
    }
    ...
    public void pushUseStonePiercingAxeEffectEvent(UseStonePiercingAxeEffectPresenter presenter) {
        ...
        try {
            for (UseStonePiercingAxeEffectPresenter.GameViewModel viewModel : viewModels) {
                String json = objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(viewModel);
                messagingTemplate.convertAndSend(String.format("/websocket/legendsOfTheThreeKingdoms/%s/%s", viewModel.getGameId(), viewModel.getPlayerId()), json);
            }
        } catch (Exception e) {
            System.err.println("****************** pushUseStonePiercingAxeEffectEvent ");
            e.printStackTrace();
        }
    }

    public void pushUseViperSpearKillEvent(UseViperSpearKillPresenter presenter) {
        List<UseViperSpearKillPresenter.GameViewModel> viewModels = presenter.present();
        try {
            for (UseViperSpearKillPresenter.GameViewModel viewModel : viewModels) {
                String json = objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(viewModel);
                messagingTemplate.convertAndSend(String.format("/websocket/legendsOfTheThreeKingdoms/%s/%s", viewModel.getGameId(), viewModel.getPlayerId()), json);
            }
        } catch (Exception e) {
            System.err.println("****************** pushUseViperSpearKillEvent ");
            e.printStackTrace();
        }
    }
    ...
    public void pushUseDismantleEvent(UseDismantlePresenter presenter) {
        ...
        try {
            for (UseDismantlePresenter.GameViewModel useDismantleViewModel : useDismantleViewModels) {
                String useDismantleJson = objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(useDismantleViewModel);
                messagingTemplate.convertAndSend(String.format("/websocket/legendsOfTheThreeKingdoms/%s/%s", useDismantleViewModel.getGameId(), useDismantleViewModel.getPlayerId()), useDismantleJson);
            }
        } catch (Exception e) {
    ...
    public void pushPlayWardCardEvent(PlayWardCardPresenter presenter) {
        List<PlayWardCardPresenter.GameViewModel> playWardCardViewModels = presenter.present();
        try {
            for (PlayWardCardPresenter.GameViewModel playWardCardViewModel : playWardCardViewModels) {
                String playerCardJson = objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(playWardCardViewModel);
                messagingTemplate.convertAndSend(String.format("/websocket/legendsOfTheThreeKingdoms/%s/%s", playWardCardViewModel.getGameId(), playWardCardViewModel.getPlayerId()), playerCardJson);
            }
        } catch (Exception e) {
            System.err.println("****************** pushPlayerCardEvent ");
            e.printStackTrace();
